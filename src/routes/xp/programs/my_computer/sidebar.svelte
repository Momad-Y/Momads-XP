    ...
    {#each menu as section}
        ...
        >
            ...
            >
                ...
                <div
                    class="shrink-0 w-4 h-4 mr-1 flex items-center justify-center rounded-full
                border border-slate-100 bg-blue-600 shadow-2xl shadow-slate-50"
                >
                    {#if hidden[section.name]}
                        <svg
                            class="fill-slate-50 w-2 h-2"
            ...
            <div
                class="overflow-hidden transition-all {hidden[section.name]
                    ? 'h-0'
                    : 'grow p-2'}"
            >
