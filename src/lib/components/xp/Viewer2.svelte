...
<script lang="ts">
    ...
    let history: (string | null | undefined)[] = [null];
    let page_index = 0;
    ...
    export let selectingItems: string[] = [];
    export let filetypes_desc: string | undefined = undefined;
    export let filetypes: string[] = [];
    export let multiple = true;

    function on_click(ev: MouseEvent | TouchEvent, item: VfsItem) {
...
>
    ...
    <div
        class="w-full bg-slate-50 grow border overflow-auto border-blue-300"
